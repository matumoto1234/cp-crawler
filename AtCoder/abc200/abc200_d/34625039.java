// detail: https://atcoder.jp/contests/abc200/submissions/34625039
...
public class Main {
    ...
    public static List<Integer> getIndexesOf1BitPosition(List<Integer> as, List<Integer> bit) {
        List<Integer> result = new ArrayList<>(as.size());
    ...
    public static void main(String[] args) {
        ...
        List<Integer> bs = getIndexesOf1BitPosition(as, bits.first);
        List<Integer> cs = getIndexesOf1BitPosition(as, bits.second);

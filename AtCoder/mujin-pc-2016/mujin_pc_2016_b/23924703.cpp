// detail: https://atcoder.jp/contests/mujin-pc-2016/submissions/23924703
#include <bits/stdc++.h>
using namespace std;
...
int main() {
  ...
  int max_radius=accumulate(vs.begin(),vs.end(),0);
  double max_cir=max_radius*max_radius*M_PI;
  double min_cir=mi*mi*M_PI;
  cout<<fixed<<setprecision(10);
  cerr<<fixed<<setprecision(10);
  debug(mi,max_radius,max_cir,min_cir);
  cout<<max_cir-min_cir<<endl;
}
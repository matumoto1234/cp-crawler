// detail: https://atcoder.jp/contests/code-festival-2015-morning-middle/submissions/21246151
#include <bits/stdc++.h>
using namespace std;
...
//  auto is_valid = [sum,r,k](ll mid,ll target){
//    return (bool)(sum+mid>=r*k);
//  };

  BinarySearch<ll,is_valid> bs(m,0);
  cout<<bs.build(0)<<endl;
}
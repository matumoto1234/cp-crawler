// detail: https://atcoder.jp/contests/joi2019yo/submissions/24269598
#include <bits/stdc++.h>
using namespace std;
...
int main() {
  ...
  for(auto a:as) if(a!=0) is_all_zero=false;
  ...
  range(i,n){
    ...
    ll islands=i+1;
    chmax(ans,islands-merge_cnt);
    // debug(i,merge_cnt,ans);
  }
  cout<<ans<<endl;
}
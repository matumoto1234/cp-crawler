// detail: https://atcoder.jp/contests/arc039/submissions/29948249
#include <bits/stdc++.h>
using namespace std;
...
string use_one(string b) {
  b[0] = '1';
  return b;
}

int solve_b(string a, string b) {
  int v1 = stoi(use_zero(b));
  int v2 = stoi(use_one(b));
  return stoi(a) - min(v1, v2);
}

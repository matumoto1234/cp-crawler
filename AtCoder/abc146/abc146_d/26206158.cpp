// detail: https://atcoder.jp/contests/abc146/submissions/26206158
#include <bits/stdc++.h>
using namespace std;
...
int main() {
  ...
  map<int,int> unique_vals;
  for(auto [edge,val]:edge_vals){
    unique_vals[val]=1;
  }

  cout<<unique_vals.size()<<endl;

  range(i,len(edges)){
    cout<<edge_vals[edges[i]]<<newl;
  }
}
// detail: https://atcoder.jp/contests/arc125/submissions/25483951
#include <bits/stdc++.h>
using namespace std;
...
// return:[idx, dist]
P bfs(const vector<int> &vs,int s,int target){
  queue<P> q;
  q.emplace(s,0);
  set<int> used;
  used.emplace(s);

// detail: https://atcoder.jp/contests/arc030/submissions/26538375
#include <bits/stdc++.h>
using namespace std;
...
int main() {
  ...
  rep (i, n) {
    if (!hs[i]) continue;
    vs.emplace_back(i);
    costs.emplace_back(G[x][i]);
  }

  auto ps = aggregate(costs, vs);

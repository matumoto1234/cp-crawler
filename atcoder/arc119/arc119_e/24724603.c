// detail: https://atcoder.jp/contests/arc119/submissions/24724603
#include <bits/stdc++.h>
using namespace std;
using ll = long long;
...
int main(){
  ...
  for(int i=0;i<(int)bs.size();i++){
    int idx=bs[i].second;
    for(ll j=i+1;j<(int)bs.size();j+=i+2){
      int idx2=bs[j].second;
      ans=min(ans,swap_query(sum,idx,idx2));
      ans=min(ans,swap_query(sum,idx,idx2+1));
      ans=min(ans,swap_query(sum,idx+1,idx2));
  ...
  for(int i=0;i<(int)bs.size();i++){
    int idx=bs[i].second;
    for(ll j=i+1;j<(int)bs.size();j+=i+3){
      int idx2=bs[j].second;
      ans=min(ans,swap_query(sum,idx,idx2));
      ans=min(ans,swap_query(sum,idx,idx2+1));
      ans=min(ans,swap_query(sum,idx+1,idx2));
  ...
  for(int i=0;i<(int)bs.size();i++){
    int idx=bs[i].second;
    for(ll j=i+1;j<(int)bs.size();j+=i+5){
      int idx2=bs[j].second;
      ans=min(ans,swap_query(sum,idx,idx2));
      ans=min(ans,swap_query(sum,idx,idx2+1));
      ans=min(ans,swap_query(sum,idx+1,idx2));
  ...
  for(int i=0;i<(int)bs.size();i++){
    int idx=bs[i].second;
    for(ll j=i+1;j<(int)bs.size();j+=i+7){
      int idx2=bs[j].second;
      ans=min(ans,swap_query(sum,idx,idx2));
      ans=min(ans,swap_query(sum,idx,idx2+1));
      ans=min(ans,swap_query(sum,idx+1,idx2));
  ...
  for(int i=0;i<(int)bs.size();i++){
    int idx=bs[i].second;
    for(ll j=i+1;j<(int)bs.size();j+=i+11){
      int idx2=bs[j].second;
      ans=min(ans,swap_query(sum,idx,idx2));
      ans=min(ans,swap_query(sum,idx,idx2+1));
      ans=min(ans,swap_query(sum,idx+1,idx2));
